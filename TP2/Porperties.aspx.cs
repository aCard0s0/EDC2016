...
namespace TP2
{
    public partial class Porperties : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            xdoc.Load(Server.MapPath(XmlDBproperties.DataFile));
            ...
            xdoc.Save(Server.MapPath(XmlDBproperties.DataFile));
        ...
        {
            XmlDocument xdoc = new XmlDocument();
            xdoc.Load(Server.MapPath(XmlDBPropOwners.DataFile));
        ...
        {
            XmlDBOwners.XPath = "properties/property[@taxnumber='"+ taxNumber.Text +"']";
        }
