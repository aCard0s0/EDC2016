<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Porperties.aspx.cs" Inherits="TP2.Porperties" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Properties</h2>
    <hr>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed " DataSourceID="XmlDBproperties"
                    GridLines="None" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" ShowFooter="True"  >
        <Columns>
            <asp:TemplateField HeaderText="Identification" SortExpression="id">
                <EditItemTemplate>
    ...
    <asp:XmlDataSource ID="XmlDBproperties" runat="server" DataFile="~/App_Data/properties/Properties.xml" TransformFile="~/App_Data/properties/PropertiesList.xslt"></asp:XmlDataSource>
    <br />
    <!-- 2 Properties Owners-->

    <h2>Properties Owners</h2>
    <hr>
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="XmlDBPropOwners" 
        ...
        <Columns>
            <asp:TemplateField HeaderText="Identification" SortExpression="id">
                ...
                <FooterTemplate>
                    <asp:TextBox ID="newOwnerId" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("id") %>'></asp:Label>
                </ItemTemplate>
    ...
    <asp:XmlDataSource ID="XmlDBPropOwners" runat="server" DataFile="~/App_Data/properties/Properties.xml" TransformFile="~/App_Data/properties/PropertiesOwners.xslt"></asp:XmlDataSource>
    <br />
    <!-- 3 Find by Owners-->

    <h2>Find properties by owned's tax number:</h2>
    <hr>
    ...
    <br />
    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" DataSourceID="XmlDBOwners" 
        CssClass="table table-condensed" GridLines="None" BorderStyle="None" HeaderStyle-BackColor="#999999" AllowPaging="True" OnDataBound="GridView3_DataBound">
        <Columns>
            <asp:BoundField DataField="Identification" HeaderText="Identification" SortExpression="Identification" />
    ...
    <asp:XmlDataSource ID="XmlDBOwners" runat="server" DataFile="~/App_Data/properties/Properties.xml" TransformFile="~/App_Data/properties/Owners.xslt"></asp:XmlDataSource>

    <!-- 4 Properties by municipality-->

    <h2>Properties by municipality</h2>
    <hr>
    <asp:Xml ID="Xml1" runat="server" DocumentSource="~/App_Data/properties/Properties.xml" TransformSource="~/App_Data/properties/Municipalities.xslt"></asp:Xml>
