<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Coursesdetail.aspx.cs" Inherits="TP2.coursesdetail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h2>Informação do curso</h2>
    <br />

    <asp:DetailsView ID="DetailsView1" runat="server"  AutoGenerateRows="False" CssClass="table table-condensed" 
        DataSourceID="XmlDataSource1" GridLines="None">

        <FieldHeaderStyle BackColor="#999999" ForeColor="White" HorizontalAlign="Right" Width="200px" />
        <Fields>
    ...
    <asp:XmlDataSource ID="XmlDataSource1" OnLoad="XmlDataSource1_Load" runat="server" TransformFile="~/App_Data/cursos/cursosDetail.xsl" XPath="/curso">
    </asp:XmlDataSource>
</asp:Content>
